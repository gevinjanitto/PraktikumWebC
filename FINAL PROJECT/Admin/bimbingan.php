...
<div id="sidebar-wrapper" style="padding-top:50px;">   
  ...
  <div class="pinggir"><br>
     ...
     <a href="bimbingan.php" style="text-decoration:none; color:black;">DAFTAR BIMBINGAN</a></div><br>
...
<!-- breadcrumb -->
<ol class="breadcrumb">
  <li><a href="data.php">ADMIN</a></li>
  <li class="active">Daftar bimbingan UNUD</li>
</ol>
<!-- title -->
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <p style="font-size:23px;color:#000000;"><b></span> DAFTAR BIMBINGAN UNUD</b></p>
