			...
			<section id="galery" class="amazing-works-area">
					...
					<div class="active-works-carousel mt-40">
						...
						<div class="item">
							...
							<div class="caption text-center">
								<h6 class="text-uppercase">Dies Natalis 2019</h6>
						...
						<div class="item">
							...
							<div class="caption text-center">
								...
								<p>Merupakan acara taunan BEM udayana untuk mengadakan konser musik yang mengundang artis ternama, pada taun itu ada HIVI dan Glen Fredly</p>
							</div>
						</div>
					</div>
			</section>
					...
					<div class="row align-items-center">
						...
						<div class="col-lg-6">
							<div class="story-box">
								...
								<a href="#" class="primary-btn hover d-inline-flex align-items-center"><span class="lnr lnr-history">&nbsp&nbsp&nbsp&nbsp</span><span class="mr-10">29 September 1958</span></span></a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-md-4">
							<div class="single-widget d-flex flex-wrap justify-content-between">
								...
								<div class="desc">
									...
									<p>Jl. Raya Kampus UNUD, Bukit Jimbaran, Kuta Selatan, Badung-Bali-80361</p>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="single-widget d-flex flex-wrap justify-content-between">
								...
								<div class="desc">
									...
									<div class="contact">
										<a href="mailto:info@unud.ac.id">info@unud.ac.id</a> <br>
										<a href="mailto:gevinjanitto@gmail.com">gevinjanitto@gmail.com</a>
									</div>
								</div>
							</div>
						</div>
			...
			<footer>
				<div class="container">
					<div class="footer-content d-flex justify-content-between align-items-center flex-wrap">
						...
						<div class="copy-right-text">Copyright &copy; 2017  |  All rights reserved to Udayana University </div>
		...
		?> <form name="daftar" onsubmit="return checkform()" method="post" action="">
			 ...
			 <div class="mt-10">
			  ...
			  <div class="mt-10">
				 ...
				 <input type="password" name="pass1" id="cekpas2" class="single-input-primary" placeholder="Masukan Kembali Password" required>
			  </div>
			  <div class="mt-10">
			  <label>
