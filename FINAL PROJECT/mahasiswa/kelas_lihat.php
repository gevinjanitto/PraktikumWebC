...
<?php $email=$_SESSION['email'];
      ...
      $sql1 = mysqli_query($koneksi, "SELECT * FROM kelas INNER JOIN dosen ON kelas.id_dsn = dosen.id_dsn INNER JOIN gabung ON kelas.id_kelas = gabung.id_kelas INNER JOIN mahasiswa ON gabung.id_mhs = mahasiswa.id_mhs WHERE nama_kelas = '$nama'");
...
<div class="row">
    ...
    <p style="font-size:20px;color:#000000;"><b></span> Nama Kelas&nbsp&nbsp: <?php echo $row['nama_kelas']; ?></b></p>
    <p style="font-size:20px;color:#000000;"><b></span> Dosen&nbsp&nbsp: <?php echo $row['nama_dsn']; ?></b></p>
    </div>
</div>
<!-- Form -->
<div class="panel-body">
  <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
       ...
       <tr><th>NO</th><th>NIM</th><th>NAMA MAHASISWA</th></tr></thead><tbody>
       <?php
      foreach ($sql1 as $row){
        echo "<tr>
            <td>$no</td>
