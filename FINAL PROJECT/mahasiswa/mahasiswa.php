...
<div id="sidebar-wrapper" style="padding-top:50px;">   
  ...
  <div class="pinggir"><br>
     ...
     <a href="mahasiswa.php" style="text-decoration:none; color:black;">DAFTAR MAHASISWA</a></div><br>
...
<ol class="breadcrumb">
  ...
  <li class="active">Daftar Mahasiswa UNUD</li>
</ol>
<!-- title -->
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <p style="font-size:23px;color:#000000;"><b></span> DAFTAR MAHASISWA UNUD</b></p>
  ...
  <div class="row">
      ...
      foreach ($sql1 as $row){
        ...
        echo "<tr>
            ...
            <td>".$row['kabkot_mhs']."</td>
            <td>".$row['jk_mhs']."</td>
            <td>".$row['tgllahir_mhs']."</td>
